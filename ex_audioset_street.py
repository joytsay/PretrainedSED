...
import wandb
from data_util.audioset_street import (get_training_dataset, get_validation_dataset, get_test_dataset,
...
def train(config):
    ...
    wandb_logger = WandbLogger(
        project="PTSED",
        notes="Downstream Training on street sound event detection.",
        tags=["AudioSet strong street", "Sound Event Detection"],
        config=config,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--experiment_name', type=str, default="AUDIOSET_STREET")
